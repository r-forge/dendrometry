...
!-----------------------------------------------------------------
!
    module GrosenbaughMod

    contains !********************************************************

    include 'FPSetup.f90'			!sets constants
	include 'jhgSBRD.f90'			!edited version of SBRD
	include 'BarkModelTwo.f90'		!Grosenbaugh's second bark model

    end Module GrosenbaughMod
